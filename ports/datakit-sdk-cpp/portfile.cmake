...
elseif(VCPKG_TARGET_IS_LINUX)
  ...
  #else()
    message(STATUS "copying release")
    file(COPY "${SOURCE_PATH}/datakit_sdk_redist/Release/lib/${ARCHITECTURE}/libft-sdk.a" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
    file(COPY "${SOURCE_PATH}/datakit_sdk_redist/Release/lib/${ARCHITECTURE}/libft-sdk.so" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
  #endif()
endif()
#endif()
