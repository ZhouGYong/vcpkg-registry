...
elseif(VCPKG_TARGET_IS_LINUX)
    ...
    file(COPY "${SOURCE_PATH}/datakit_sdk_redist/Debug/lib/${ARCHITECTURE}/libft-sdk.so" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
  #else()
    message(STATUS "copying release")
    file(COPY "${SOURCE_PATH}/datakit_sdk_redist/Release/lib/${ARCHITECTURE}/ft-sdk.lib" DESTINATION "${CURRENT_PACKAGES_DIR}/lib")
    file(COPY "${SOURCE_PATH}/datakit_sdk_redist/Release/lib/${ARCHITECTURE}/ft-sdk.dll" DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
  #endif()
endif()
#endif()
